...
function xmldb_courseboard_upgrade($oldversion=0) {
...
// for demonstrative purposes and to show how the courseboard
// iself has been upgraded.

// For each upgrade block, the file courseboard/version.php
...
if ($result && $oldversion < 2007040100) {
    ...
    // Define field course to be added to courseboard.
    $table = new XMLDBTable('courseboard');
    $field = new XMLDBField('course');
    $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    // Launch add field course.
    $result = $result && add_field($table, $field);

    // Define field intro to be added to courseboard.
    $table = new XMLDBTable('courseboard');
    ...
    // Define field introformat to be added to courseboard.
    $table = new XMLDBTable('courseboard');
...
if ($result && $oldversion < 2007040101) {
    ...
    // Define field timecreated to be added to courseboard.
    $table = new XMLDBTable('courseboard');
    ...
    // Define field timemodified to be added to courseboard.
    $table = new XMLDBTable('courseboard');
    ...
    // Define index course (not unique) to be added to courseboard.
    $table = new XMLDBTable('courseboard');
...
if ($result && $oldversion < 2007040200) {
    ...
    $rec = new stdClass;
    $rec->module = 'courseboard';
    $rec->action = 'add';
    $rec->mtable = 'courseboard';
    $rec->filed  = 'name';
